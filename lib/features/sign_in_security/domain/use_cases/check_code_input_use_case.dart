...
class CheckCodeInputUseCase
    extends BaseUseCase<String, SignInSecurityEntity> {
  final SignInAndSecurityRepo _signInAndSecurityRepo;

  CheckCodeInputUseCase({required SignInAndSecurityRepo signInAndSecurityRepo})
  ...
  Future<Either<FailureServ, String>> call(
    ...
    return await _signInAndSecurityRepo.checkCodeInput(
      model: parameter,
    );
  }
}
