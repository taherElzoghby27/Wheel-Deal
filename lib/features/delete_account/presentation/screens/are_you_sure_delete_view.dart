...
import '../widgets/are_you_sure_delete_body.dart';

class AreYouSureDeleteAccountView extends StatelessWidget {
  const AreYouSureDeleteAccountView({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const SafeArea(
        child: AreYouSureDeleteAccountBody(),
      ),
    );
  }
}
